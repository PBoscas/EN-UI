 ...
 * ============================================= */
!function($) {
    if (void 0 === $.fn.tooltip.Constructor) throw new Error("Bootstrap Tooltip must be included first!");
    ...
    Tooltip.prototype.show = function() {
        ...
        _show.apply(this, Array.prototype.slice.apply(arguments)), this.config.customClass && (tip = this.getTipElement(), 
